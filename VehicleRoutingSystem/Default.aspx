<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="VehicleRoutingSystem._Default" %>
	...
	<div id="content">
		...
		<div class="indent">
			<div class="wrapper"><br /><br /><br />
				<div class="col-1">
					<h3><b>Welcome to</b> Vehicle Routing System</h3>
                    ...
                    <div class="img-box1"><img src="images/1page-img.jpg" alt="" />
						<p class="p0">A CVRP consists of one warehouse and several nodes each of which has a demand to be fulfilled by delivery trucks based in the warehouse. These trucks will have a maximum capacity. The objective of solving this problem is to find the minimum number of routes which will add up to having the minimum total distance which will also maximize the utilization of truck capacity. This in turn would ensure the least distribution cost for the company.</p>
					</div>
					<p>Solving this problem requires a lot of effort if done manually because the complexity of this problem increases exponentially with each additional node. Another difficulty faced by users is that the solution needs to be recalculated each time a node is added or removed, location's demand changes, etc.</p>
