<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Distances.aspx.cs" Inherits="VehicleRoutingSystem.Distances" %>
		...
		<div class="indent">
			<div class="wrapper"><br /><br /><br />
                ...
                <p><asp:Label runat="server" ID="lblMessage"></asp:Label></p>					
                    ...
                    <h3><b>Enter/Edit</b> Distances</h3>
					<p>Here's the most important part. Please enter/edit the distances between each node mentioned below.</p>
                    
					
                        <asp:Panel runat="server" ID="pnlDistances"></asp:Panel>
                        
                        
                        <div>
                            <asp:Button ID="btnPrevious6" runat="server" CssClass="btn" Height="35px" 
                                Text="Previous" Width="125px" onclick="btnPrevious6_Click" />
                            <asp:Button ID="btnNext6" runat="server" CssClass="btnNext" Height="35px" 
                                Text="Next" Width="125px" onclick="btnNext6_Click" ValidationGroup = "Distance"/>
                        </div>
